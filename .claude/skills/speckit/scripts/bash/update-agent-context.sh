...
# Template file (speckit skill pack or repo override)
TEMPLATE_FILE="${SPECKIT_ROOT}/templates/agent-file-template.md"
if [[ ! -f "$TEMPLATE_FILE" ]]; then
    TEMPLATE_FILE="$REPO_ROOT/.claude/speckit-overrides/templates/agent-file-template.md"
fi
[[ -f "$TEMPLATE_FILE" ]] || TEMPLATE_FILE="$REPO_ROOT/.specify/templates/agent-file-template.md"
